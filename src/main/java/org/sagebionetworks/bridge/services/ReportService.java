...
public class ReportService {
    ...
    public void updateReportIndex(String appId, ReportType reportType, ReportIndex index) {
        ...
        Set<String> callerRoles = BridgeUtils.getRequestContext().getOrgSponsoredStudies();
    ...
    protected boolean canAccess(ReportIndex index) {
        ...
        allStudyIds.addAll(BridgeUtils.getRequestContext().getCallerStudies());
        allStudyIds.addAll(BridgeUtils.getRequestContext().getOrgSponsoredStudies());
