...
public class HibernateSchedule2Dao implements Schedule2Dao {
    ...
    static final String SELECT_METADATA_FOR_SCHEDULE = "SELECT * from TimelineMetadata where scheduleGuid = :scheduleGuid "
    ...
    public List<TimelineMetadata> getScheduleMetadata(String scheduleGuid) {
        ...
        QueryBuilder builder = new QueryBuilder();
        builder.append(SELECT_METADATA_FOR_SCHEDULE, SCHEDULE_GUID, scheduleGuid);
