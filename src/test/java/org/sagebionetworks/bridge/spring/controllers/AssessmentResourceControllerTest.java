...
public class AssessmentResourceControllerTest extends Mockito {
    ...
    public void beforeMethod() { 
        ...
        session.setStudyIdentifier(new StudyIdentifierImpl(API_APP_ID));
    }
    ...
    public void getAssessmentResources() {
        ...
        when(mockService.getResources(API_APP_ID, ASSESSMENT_ID, 10, 100, RESOURCE_CATEGORIES, 1, 1000, true)).thenReturn(page);
        ...
        verify(mockService).getResources(API_APP_ID, ASSESSMENT_ID, 10, 100, RESOURCE_CATEGORIES, 1, 1000, true);
    }
    ...
    public void getAssessmentResourcesNoArguments() {
        ...
        PagedResourceList<AssessmentResource> page = new PagedResourceList<>(
                ImmutableList.of(AssessmentResourceTest.createAssessmentResource()), 100);
        when(mockService.getResources(API_APP_ID, ASSESSMENT_ID, 0, API_DEFAULT_PAGE_SIZE, 
        ...
        verify(mockService).getResources(API_APP_ID, ASSESSMENT_ID, 0, API_DEFAULT_PAGE_SIZE, null, null, null, false);
    }
    ...
    public void createAssessmentResource() throws Exception {
        ...
        verify(mockService).createResource(eq(API_APP_ID), eq(ASSESSMENT_ID), resourceCaptor.capture());
    ...
    public void getAssessmentResource() {
        ...
        AssessmentResource resource = AssessmentResourceTest.createAssessmentResource();
        when(mockService.getResource(API_APP_ID, ASSESSMENT_ID, GUID)).thenReturn(resource);
    ...
    public void updateAssessmentResource() throws Exception {
        ...
        verify(mockService).updateResource(eq(API_APP_ID), eq(ASSESSMENT_ID), resourceCaptor.capture());
        assertEquals(resourceCaptor.getValue().getTitle(), resource.getTitle());
    ...
    public void deleteAssessmentResourceDefaultsToLogical() {
        ...
        verify(mockService).deleteResource(API_APP_ID, ASSESSMENT_ID, GUID);
    }
    ...
    public void deleteAssessmentResourceAdminCanBePhysical() {
        ...
        doReturn(session).when(controller).getAuthenticatedSession(DEVELOPER, ADMIN);
        controller.deleteAssessmentResource(ASSESSMENT_ID, GUID, "true");
        verify(mockService).deleteResourcePermanently(API_APP_ID, ASSESSMENT_ID, GUID);
    }
    ...
    public void publishAssessmentResource() throws Exception {
        ...
        verify(mockService).publishAssessmentResources(API_APP_ID, ASSESSMENT_ID, guids);
    }
