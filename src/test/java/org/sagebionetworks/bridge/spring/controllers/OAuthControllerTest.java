...
public class OAuthControllerTest extends Mockito {
    ...
    public void requestAccessTokenWithAccessToken() throws Exception {
        ...
        OAuthAuthorizationToken authToken = new OAuthAuthorizationToken(TEST_STUDY_IDENTIFIER, null, AUTH_TOKEN, null);
    ...
    public void getHealthCodesGrantingAccessWithDefaults() throws Exception {
        ...
        ForwardCursorPagedResourceList<String> result = controller.getHealthCodesGrantingAccess(TEST_STUDY_IDENTIFIER,
                VENDOR_ID, null, null);
    ...
    public void getAccessToken() throws Exception {
        ...
        OAuthAccessToken result = controller.getAccessToken(TEST_STUDY_IDENTIFIER, VENDOR_ID, HEALTH_CODE);
