...
public class NotificationRegistrationControllerTest extends Mockito {
    ...
    public void createRegistration() throws Exception {
        ...
        // Verify service.
        verify(mockNotificationService).createRegistration(eq(TEST_STUDY_IDENTIFIER), any(), registrationCaptor.capture());
    ...
    public void updateRegistration() throws Exception {
        ...
        verify(mockNotificationService).updateRegistration(eq(TEST_STUDY_IDENTIFIER), registrationCaptor.capture());
        NotificationRegistration registration = registrationCaptor.getValue();
    ...
    public void deleteRegistration() throws Exception {
        ...
        verify(mockNotificationService).deleteRegistration(TEST_STUDY_IDENTIFIER, HEALTH_CODE, GUID);
    }
    ...
    public void getSubscriptionStatuses() throws Exception {
        ...
        doReturn(ImmutableList.of(status)).when(mockTopicService)
                .currentSubscriptionStatuses(TEST_STUDY_IDENTIFIER, HEALTH_CODE, GUID);
    ...
    public void subscribe() throws Exception {
        doReturn(mockSession).when(controller).getAuthenticatedAndConsentedSession();
        SubscriptionStatus status = new SubscriptionStatus("topicGuid","topicName",true);
        doReturn(ImmutableList.of(status)).when(mockTopicService).subscribe(eq(TEST_STUDY_IDENTIFIER), eq(HEALTH_CODE), eq(GUID),
                any());
        ...
        verify(mockTopicService).subscribe(eq(TEST_STUDY_IDENTIFIER), eq(HEALTH_CODE), stringCaptor.capture(),
