...
public class ReportDataKeyValidatorTest {
    ...
    public void reportTypeMissing() {
        test(() -> {
            new ReportDataKey.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER).withHealthCode("ABC")
    ...
    public void healthCodeMissing() {
        test(() -> {
            new ReportDataKey.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER).withIdentifier("foo")
                    .withReportType(ReportType.PARTICIPANT).build();
    ...
    public void identifierMissing() {
        test(() -> {
            new ReportDataKey.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER)
                    .withReportType(ReportType.STUDY).build();
    ...
    public void identifierInvalid() {
        test(() -> {
            new ReportDataKey.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER).withIdentifier("My Report")
                    .withReportType(ReportType.STUDY).build();
