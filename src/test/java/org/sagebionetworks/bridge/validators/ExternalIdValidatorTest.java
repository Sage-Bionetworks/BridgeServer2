...
public class ExternalIdValidatorTest {
    ...
    public void validates() {
        ...
        when(substudyService.getSubstudy(API_APP_ID, "substudy-id", false)).thenReturn(Substudy.create());
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, "one-id");
    ...
    public void identifierCannotBeNull() {
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, null);
        assertValidatorMessage(validatorV4, id, "identifier", "cannot be null or blank");
    }
    
    @Test
    public void identifierCannotBeBlank() {
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, "\t");
        assertValidatorMessage(validatorV4, id, "identifier", "cannot be null or blank");
    }
    
    @Test
    public void identifierMustMatchPattern1() {
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, "two words");
    ...
    public void identifierMustMatchPattern2() {
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, "<Funky>Markup");
        assertValidatorMessage(validatorV4, id, "identifier",
    ...
    public void identifierMustMatchPattern3() {
        ExternalIdentifier id = ExternalIdentifier.create(API_APP_ID, "And a \ttab character");
        assertValidatorMessage(validatorV4, id, "identifier",
