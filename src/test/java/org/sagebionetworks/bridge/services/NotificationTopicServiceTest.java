...
public class NotificationTopicServiceTest {
    ...
    public void listTopics() {
        ...
        doReturn(list).when(mockTopicDao).listTopics(TEST_STUDY_IDENTIFIER, true);
        
        List<NotificationTopic> results = service.listTopics(TEST_STUDY_IDENTIFIER, true);
        assertEquals(results.size(), 2);
        
        verify(mockTopicDao).listTopics(TEST_STUDY_IDENTIFIER, true);
    }
    
    @Test
    public void getTopic() {
        NotificationTopic topic = getNotificationTopic();
        doReturn(topic).when(mockTopicDao).getTopic(TEST_STUDY_IDENTIFIER, topic.getGuid());
        
        NotificationTopic result = service.getTopic(TEST_STUDY_IDENTIFIER, topic.getGuid());
        assertEquals(result, topic);
        
        verify(mockTopicDao).getTopic(TEST_STUDY_IDENTIFIER, topic.getGuid());
    }
    ...
    public void deleteTopic() {
        service.deleteTopic(TEST_STUDY_IDENTIFIER, "ABC-DEF");
        
        verify(mockTopicDao).deleteTopic(TEST_STUDY_IDENTIFIER, "ABC-DEF");
    }
    
    @Test
    public void deleteTopicPermanently() {
        service.deleteTopicPermanently(TEST_STUDY_IDENTIFIER, "ABC-DEF");
        
        verify(mockTopicDao).deleteTopicPermanently(TEST_STUDY_IDENTIFIER, "ABC-DEF");
    }
    
    @Test
    public void deleteAllTopics() {
        service.deleteAllTopics(TEST_STUDY_IDENTIFIER);
        
        verify(mockTopicDao).deleteAllTopics(TEST_STUDY_IDENTIFIER);
    }
    ...
    public void sendNotification() {
        ...
        doReturn(topic).when(mockTopicDao).getTopic(TEST_STUDY_IDENTIFIER, "ABC-DEF");
        
        service.sendNotification(TEST_STUDY_IDENTIFIER,  "ABC-DEF", message);
    ...
    public void currentSubscriptionStatuses() {
        ...
        doReturn(allTopics).when(mockTopicDao).listTopics(TEST_STUDY_IDENTIFIER, false);
        
        List<SubscriptionStatus> statuses = service.currentSubscriptionStatuses(TEST_STUDY_IDENTIFIER, "healthCode", "registrationGuid");
    ...
    public void manageCriteriaBasedSubscriptions_NoCriteriaTopics() {
        ...
        when(mockTopicDao.listTopics(TEST_STUDY_IDENTIFIER, true)).thenReturn(ImmutableList.of(MANUAL_TOPIC_1, MANUAL_TOPIC_2));

        // Execute test.
        service.manageCriteriaBasedSubscriptions(TEST_STUDY_IDENTIFIER, EMPTY_CONTEXT, HEALTH_CODE);
    ...
    public void manageCriteriaBasedSubscriptions_NoRegistrations() {
        // Mock back-ends.
        when(mockTopicDao.listTopics(TEST_STUDY_IDENTIFIER, true)).thenReturn(ImmutableList.of(CRITERIA_TOPIC_1, CRITERIA_TOPIC_2,
    ...
    public void manageCriteriaBasedSubscriptions() {
        ...
        // Execute test.
        service.manageCriteriaBasedSubscriptions(TEST_STUDY_IDENTIFIER, context, HEALTH_CODE);
    ...
    public void unsubscribeAll_NoSubscriptions() {
        ...
        // Execute.
        service.unsubscribeAll(TEST_STUDY_IDENTIFIER, HEALTH_CODE, SMS_REGISTRATION.getGuid());
    ...
    public void unsubscribeAll() {
        ...
        when(mockTopicDao.getTopic(TEST_STUDY_IDENTIFIER, MANUAL_TOPIC_1.getGuid())).thenReturn(MANUAL_TOPIC_1);
        when(mockTopicDao.getTopic(TEST_STUDY_IDENTIFIER, MANUAL_TOPIC_2.getGuid())).thenReturn(MANUAL_TOPIC_2);
        when(mockTopicDao.getTopic(TEST_STUDY_IDENTIFIER, MANUAL_TOPIC_3.getGuid())).thenReturn(MANUAL_TOPIC_3);
    ...
    public void subscribe_NoManualTopics() {
        ...
        when(mockTopicDao.listTopics(TEST_STUDY_IDENTIFIER, false)).thenReturn(ImmutableList.of(CRITERIA_TOPIC_1, CRITERIA_TOPIC_2));

        // Execute test. We pass in criteria topic guids for test purposes, but these are ignored.
        List<SubscriptionStatus> statusList = service.subscribe(TEST_STUDY_IDENTIFIER, HEALTH_CODE, PUSH_REGISTRATION.getGuid(),
