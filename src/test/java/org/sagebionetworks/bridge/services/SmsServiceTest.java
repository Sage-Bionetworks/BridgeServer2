...
public class SmsServiceTest {
    ...
    public void before() {
        ...
        when(mockSchemaService.getUploadSchemaByIdAndRev(TEST_STUDY_IDENTIFIER, SmsService.MESSAGE_LOG_SCHEMA_ID,
    ...
    public void sendSmsMessage_SchemaDoesNotExist() {
        ...
        verify(mockSchemaService).createSchemaRevisionV4(eq(TEST_STUDY_IDENTIFIER), schemaCaptor.capture());
    ...
    private void verifyHealthData(StudyParticipant expectedParticipant, DateTimeZone expectedTimeZone,
        ...
        verify(mockHealthDataService).submitHealthData(eq(TEST_STUDY_IDENTIFIER), same(expectedParticipant),
    ...
    private static SmsMessage makeValidSmsMessage() {
        ...
        message.setStudyId(TEST_STUDY_IDENTIFIER);
        return message;
    }
