...
public class IntentServiceTest {
    ...
    public void submitIntentToParticipateWithPhone() {
        ...
        CacheKey cacheKey = CacheKey.itp(SubpopulationGuid.create("subpopGuid"), API_APP_ID,
                TestConstants.PHONE);
        
        service.submitIntentToParticipate(intent);
        
        verify(mockSubpopService).getSubpopulation(eq(API_APP_ID), subpopGuidCaptor.capture());
    ...
    public void registerIntentToParticipateWithPhone() {
        ...
        CacheKey key = CacheKey.itp(SubpopulationGuid.create("BBB"), API_APP_ID, TestConstants.PHONE);
        
        when(mockStudy.getIdentifier()).thenReturn(API_APP_ID);
        when(mockSubpopService.getSubpopulations(API_APP_ID, false))
    ...
    public void registerIntentToParticipateWithEmail() {
        ...
        CacheKey key = CacheKey.itp(SubpopulationGuid.create("BBB"), API_APP_ID, TestConstants.EMAIL);
    ...
    public void registerIntentToParticipateWithMultipleConsents() {
        ...
        CacheKey keyAAA = CacheKey.itp(SubpopulationGuid.create("AAA"), API_APP_ID, TestConstants.PHONE);
        CacheKey keyBBB = CacheKey.itp(SubpopulationGuid.create("BBB"), API_APP_ID, TestConstants.PHONE);
    ...
    public void noIntentDoesNothing() {
        ...
        CacheKey key = CacheKey.itp(SubpopulationGuid.create("BBB"), API_APP_ID, PHONE);
    ...
    public void submitIntentToParticipateWithoutInstallLinks() {
        ...
        CacheKey cacheKey = CacheKey.itp(SubpopulationGuid.create("subpopGuid"), API_APP_ID, PHONE);
