...
public class ParticipantServiceTest extends Mockito {
    ...
    private static final CriteriaContext CONTEXT = new CriteriaContext.Builder()
            .withUserId(ID).withStudyIdentifier(TEST_STUDY_IDENTIFIER).build();
    ...
    public void before() {
        ...
        extId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, EXTERNAL_ID);
    ...
    public void createParticipant() {
        ...
        when(participantService.generateGUID()).thenReturn(ID);
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID)).thenReturn(Optional.of(extId));
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, SUBSTUDY_ID, false)).thenReturn(Substudy.create());
    ...
    public void createParticipantWithExternalIdValidation() {
        mockHealthCodeAndAccountRetrieval();
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID))
    ...
    public void createParticipantWithExternalIdAndSubstudyCallerValidates() { 
        ...
        ExternalIdentifier extId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, EXTERNAL_ID);
        extId.setSubstudyId("substudy1");
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID)).thenReturn(Optional.of(extId));
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, "substudy1", false)).thenReturn(Substudy.create());
    ...
    public void createParticipantWithExternalIdAndSubstudyCallerThatDontMatch() throws Exception { 
        ...
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID)).thenReturn(Optional.of(extId));
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, "substudy2", false)).thenReturn(Substudy.create());
    ...
    public void createParticipantWithMissingExternalIdAndSubstudyCaller() { 
        ...
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID)).thenReturn(Optional.empty());
    ...
    public void createSmsNotificationRegistration_NotConsented() {
        ...
        when(subpopService.getSubpopulations(TEST_STUDY_IDENTIFIER, false)).thenReturn(
    ...
    public void createSmsNotificationRegistration_Success() {
        ...
        verify(notificationsService).createRegistration(eq(TEST_STUDY_IDENTIFIER), criteriaContextCaptor.capture(),
                registrationCaptor.capture());

        CriteriaContext criteriaContext = criteriaContextCaptor.getValue();
        assertEquals(criteriaContext.getStudyIdentifier(), TEST_STUDY_IDENTIFIER);
    ...
    public void getSelfParticipantWithHistory() throws Exception {
        ...
        when(subpopService.getSubpopulations(TEST_STUDY_IDENTIFIER, false)).thenReturn(subpops);
        when(subpopService.getSubpopulation(TEST_STUDY_IDENTIFIER, subpopGuid)).thenReturn(subpop);
    ...
    public void getStudyParticipant() {
        ...
        when(subpopService.getSubpopulations(TEST_STUDY_IDENTIFIER, false)).thenReturn(subpopulations);

        when(subpopService.getSubpopulation(TEST_STUDY_IDENTIFIER, SUBPOP_GUID_1)).thenReturn(subpop1);
    ...
    public void getParticipantWithHistories() {
        ...
        doReturn(Lists.newArrayList(subpopulation)).when(subpopService).getSubpopulations(TEST_STUDY_IDENTIFIER, false);
    ...
    public void sendNotification() {
        ...
        verify(notificationsService).sendNotificationToUser(TEST_STUDY_IDENTIFIER, HEALTH_CODE, message);
    }
    ...
    public void updateIdentifiersCanAddExternalIdInOtherSubstudy() {
        ...
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "newExtId")).thenReturn(Optional.of(extId));
    ...
    public void updateIdentifiersAssignsExternalIdEvenWhenAlreadyAssigned() {
        ...
        ExternalIdentifier newExtId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, "newExternalId");
        newExtId.setSubstudyId("substudyA");
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "newExternalId")).thenReturn(Optional.of(newExtId));
    ...
    public void updateIdentifiersCreatesExternalIdWithAssignment() {
        ExternalIdentifier differentExternalId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, "extid");
    ...
    public void changingExternalIdDoesNotWork() throws Exception {
        ExternalIdentifier newExternalId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, "newExternalId");
        newExternalId.setSubstudyId(SUBSTUDY_ID);
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "newExternalId")).thenReturn(Optional.of(newExternalId));
        
        ExternalIdentifier identifier = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, "oldExternalId");
        identifier.setSubstudyId(SUBSTUDY_ID);
        identifier.setHealthCode(HEALTH_CODE);
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "oldExternalId")).thenReturn(Optional.of(identifier));
    ...
    public void updateParticipantAsResearcherExternalIdsExistNoneMatchOneAddedUpdates() {
        ...
        ExternalIdentifier nextExtId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, "newExternalId");
        nextExtId.setSubstudyId(SUBSTUDY_ID);
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "newExternalId"))
    ...
    public void normalUserCannotChangeExternalIdOnUpdate() {
        ...
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "differentId")).thenReturn(Optional.of(extId));
    ...
    public void beginAssignExternalId() {
        ...
        ExternalIdentifier existing = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, EXTERNAL_ID);
        existing.setSubstudyId(SUBSTUDY_ID);
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, EXTERNAL_ID)).thenReturn(Optional.of(existing));
    ...
    public void beginAssignExternalIdIdentifierObjectMissing() {
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, ID)).thenReturn(Optional.empty());
    ...
    public void beginAssignExternalIdHealthCodeExistsNotEqual() {
        ...
        ExternalIdentifier existing = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, ID);
        existing.setHealthCode("anotherHealthCode");
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, ID)).thenReturn(Optional.of(existing));
    ...
    public void substudyResearcherCannotAddSubstudyIdOnUpdate() {
        BridgeUtils.setRequestContext(new RequestContext.Builder()
                ...
                .withCallerRoles(ImmutableSet.of(RESEARCHER)).build());
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, SUBSTUDY_ID, false)).thenReturn(Substudy.create());
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, "secondSubstudyId", false)).thenReturn(Substudy.create());
        account.setId(ID);
        account.getAccountSubstudies().add(AccountSubstudy.create(TEST_STUDY_IDENTIFIER, SUBSTUDY_ID, ID));
        when(accountService.getAccount(ACCOUNT_ID)).thenReturn(account);
    ...
    public void substudyResearcherCannotAddExternalIdOfOtherSubstudyOnCreate() {
        ...
        when(externalIdService.getExternalId(TEST_STUDY_IDENTIFIER, "otherExternalId")).thenReturn(Optional.of(extId));
        when(participantService.generateGUID()).thenReturn(ID, HEALTH_CODE);
    ...
    public void substudyResearcherCannotAddSubstudyIdOfOtherSubstudyOnUpdate() {
        BridgeUtils.setRequestContext(new RequestContext.Builder()
                .withCallerSubstudies(ImmutableSet.of(SUBSTUDY_ID))
                .withCallerRoles(ImmutableSet.of(RESEARCHER)).build());
        when(substudyService.getSubstudy(TEST_STUDY_IDENTIFIER, "someOtherSubstudy", false)).thenReturn(Substudy.create());
        account.getAccountSubstudies().add(AccountSubstudy.create(TEST_STUDY_IDENTIFIER, SUBSTUDY_ID, ID));
        when(accountService.getAccount(ACCOUNT_ID)).thenReturn(account);
    ...
    private StudyParticipant.Builder mockSubstudiesInRequest(Set<String> callerSubstudies, Set<String> participantSubstudies, Roles... callerRoles) {
        ...
        for (String substudyId : callerSubstudies) {
            when(substudyService.getSubstudy(STUDY.getIdentifier(), substudyId, false)).thenReturn(Substudy.create());
        }
