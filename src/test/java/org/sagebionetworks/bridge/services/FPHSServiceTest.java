...
public class FPHSServiceTest {
    ...
    public void before() {
        ...
        externalId = ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, EXTERNAL_ID);
    ...
    public void validateIdThrowsException() throws Exception {
        service.verifyExternalIdentifier(ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, ""));
    }
    ...
    public void registerIdThrowsException() throws Exception {
        service.registerExternalIdentifier(TEST_STUDY_IDENTIFIER, EXTERNAL_ID, ExternalIdentifier.create(TEST_STUDY_IDENTIFIER, null));
    }
    ...
    public void registerExternalIdentifier() throws Exception {
        ...
        service.registerExternalIdentifier(TEST_STUDY_IDENTIFIER, EXTERNAL_ID, externalId);
