...
public class TemplateRevisionServiceTest extends Mockito {
    ...
    public void getTemplateRevisions() {
        ...
        PagedResourceList<? extends TemplateRevision> result = service.getTemplateRevisions(TestConstants.TEST_STUDY_IDENTIFIER,
    ...
    public void getTemplateRevisionsTemplateNotFound() {
        service.getTemplateRevisions(TestConstants.TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, 400, 20);
    }
    ...
    public void getTemplateRevisionsSetsDefaults() {
        ...
        service.getTemplateRevisions(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, null, null);
    ...
    public void getTemplateRevisionsOffsetNegative() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, -1, null);
    }
    ...
    public void getTemplateRevisionsExceedMaxPageSize() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, 0, 1000);
    }
    ...
    public void getTemplateRevisionsMinPageZero() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, 0, 0);
    }
    ...
    public void createTemplateRevision() throws Exception {
        ...
        CreatedOnHolder holder = service.createTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, revision);
    ...
    public void createTemplateRevisionTemplateNotFound() throws Exception {
        TemplateRevision revision = TemplateRevision.create();
        service.createTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, revision);
    }
    ...
    public void createTemplateRevisionInvalid() throws Exception {
        ...
        service.createTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, TemplateRevision.create());        
    }
    ...
    public void getTemplateRevision() throws Exception {
        ...
        TemplateRevision returned = service.getTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, CREATED_ON);
        assertSame(returned, revision);
        
        verify(mockTemplateDao).getTemplate(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID);
    ...
    public void getTemplateRevisionTemplateNotFound() throws Exception { 
        service.getTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, CREATED_ON);
    }
    ...
    public void publishTemplateRevision() {
        ...
        service.publishTemplateRevision(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID, CREATED_ON);
    ...
    private void mockGetTemplate() {
        ...
        when(mockTemplateDao.getTemplate(TEST_STUDY_IDENTIFIER, TEMPLATE_GUID)).thenReturn(Optional.of(template));
    }
