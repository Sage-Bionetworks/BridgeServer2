...
public class TemplateRevisionServiceTest extends Mockito {
    ...
    public void getTemplateRevisions() {
        ...
        PagedResourceList<? extends TemplateRevision> result = service.getTemplateRevisions(TestConstants.TEST_STUDY,
    ...
    public void getTemplateRevisionsTemplateNotFound() {
        service.getTemplateRevisions(TestConstants.TEST_STUDY, TEMPLATE_GUID, 400, 20);
    }
    ...
    public void getTemplateRevisionsSetsDefaults() {
        ...
        service.getTemplateRevisions(TEST_STUDY, TEMPLATE_GUID, null, null);
    ...
    public void getTemplateRevisionsOffsetNegative() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY, TEMPLATE_GUID, -1, null);
    }
    ...
    public void getTemplateRevisionsExceedMaxPageSize() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY, TEMPLATE_GUID, 0, 1000);
    }
    ...
    public void getTemplateRevisionsMinPageZero() {
        mockGetTemplate();
        service.getTemplateRevisions(TEST_STUDY, TEMPLATE_GUID, 0, 0);
    }
    ...
    public void createTemplateRevisionInvalid() throws Exception {
        ...
        service.createTemplateRevision(TEST_STUDY, TEMPLATE_GUID, TemplateRevision.create());        
    }
