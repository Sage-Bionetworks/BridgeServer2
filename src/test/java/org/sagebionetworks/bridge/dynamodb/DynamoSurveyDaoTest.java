...
public class DynamoSurveyDaoTest extends Mockito {
    ...
    public void updateSurvey() {
        ...
        Survey result = dao.updateSurvey(TEST_STUDY_IDENTIFIER, survey);
    ...
    public void versionSurvey() {
        ...
        Survey result = dao.versionSurvey(TEST_STUDY_IDENTIFIER, SURVEY_KEYS);
    ...
    public void publishSurveySchemaRevision() {
        ...
        when(mockUploadSchemaService.createUploadSchemaFromSurvey(TEST_STUDY_IDENTIFIER, survey, true)).thenReturn(savedSchema);
        
        Survey result = dao.publishSurvey(TEST_STUDY_IDENTIFIER, survey, true);
        assertTrue(survey.isPublished());
        assertEquals(result.getModifiedOn(), TIMESTAMP);
        assertEquals(result.getSchemaRevision(), new Integer(3));
        
        verify(mockUploadSchemaService).createUploadSchemaFromSurvey(TEST_STUDY_IDENTIFIER, survey, true);
    }
    ...
    public void publishSurveyNoSchemaRevision() {
        ...
        DynamoUploadSchema savedSchema = new DynamoUploadSchema();
        savedSchema.setRevision(3);
        when(mockUploadSchemaService.createUploadSchemaFromSurvey(TEST_STUDY_IDENTIFIER, survey, false)).thenReturn(savedSchema);
        
        Survey result = dao.publishSurvey(TEST_STUDY_IDENTIFIER, survey, false);
        assertTrue(survey.isPublished());
        assertEquals(result.getModifiedOn(), TIMESTAMP);
        assertEquals(result.getSchemaRevision(), new Integer(3));
        
        verify(mockUploadSchemaService).createUploadSchemaFromSurvey(TEST_STUDY_IDENTIFIER, survey, false);
    }
    ...
    public void publishSurveyAlreadyPublished() {
        DynamoSurvey survey = new DynamoSurvey();
        survey.setPublished(true);
        dao.publishSurvey(TEST_STUDY_IDENTIFIER, survey, true);
    ...
    public void deleteSurveyPermanently() {
        ...
        dao.deleteSurveyPermanently(TEST_STUDY_IDENTIFIER, SURVEY_KEYS);
        
        verify(mockSurveyMapper).delete(survey);
        verify(mockUploadSchemaService).deleteUploadSchemaByIdPermanently(TEST_STUDY_IDENTIFIER, SURVEY_ID);
    }
    ...
    public void getSurveyIncludeElements() {
        ...
        Survey result = dao.getSurvey(TEST_STUDY_IDENTIFIER, SURVEY_KEYS, true);
        assertSame(result, survey);
    ...
    public void getSurveyExcludeElements() {
        ...
        Survey result = dao.getSurvey(TEST_STUDY_IDENTIFIER, SURVEY_KEYS, false);
        assertSame(result, survey);
    ...
    public void getSurveyNotFound() {
        ...
        assertNull(dao.getSurvey(TEST_STUDY_IDENTIFIER, SURVEY_KEYS, true));
    }
    ...
    public void getSurveyGuidForIdentifier() {
        ...
        String result = dao.getSurveyGuidForIdentifier(TEST_STUDY_IDENTIFIER, SURVEY_ID);
    ...
    public void getSurveyAllVersionsIncludeDeleted() {
        ...
        List<Survey> results = dao.getSurveyAllVersions(TEST_STUDY_IDENTIFIER, GUID, true);
    ...
    public void getSurveyAllVersionsExcludeDeleted() {
        ...
        List<Survey> results = dao.getSurveyAllVersions(TEST_STUDY_IDENTIFIER, GUID, false);
        assertEquals(results, surveyList);
    ...
    public void getSurveyMostRecentVersion() {
        ...
        Survey survey = dao.getSurveyMostRecentVersion(TEST_STUDY_IDENTIFIER, GUID);
    ...
    public void getSurveyMostRecentlyPublishedVersionIncludeElements() {
        ...
        Survey result = dao.getSurveyMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, GUID, true);
    ...
    public void getSurveyMostRecentlyPublishedVersionExcludeElements() {
        ...
        dao.getSurveyMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, GUID, false);
    ...
    public void getAllSurveysMostRecentlyPublishedVersionIncludeDeleted() {
        ...
        List<Survey> results = dao.getAllSurveysMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, true);
    ...
    public void getAllSurveysMostRecentlyPublishedVersionExcludeDeleted() {
        ...
        dao.getAllSurveysMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, false);
    ...
    public void getAllSurveysMostRecentVersionIncludeDeleted() {
        ...
        List<Survey> results = dao.getAllSurveysMostRecentVersion(TEST_STUDY_IDENTIFIER, true);
        assertEquals(results.size(), 2);
        assertEquals(results.get(0).getCreatedOn(), TIMESTAMP);
        assertEquals(results.get(1).getCreatedOn(), TIMESTAMP);
        assertEquals(ImmutableSet.of(results.get(0).getGuid(), results.get(1).getGuid()),
    ...
    public void getAllSurveysMostRecentVersionExcludeDeleted() {
        ...
        dao.getAllSurveysMostRecentVersion(TEST_STUDY_IDENTIFIER, false);
    ...
    public void getSurveyIncludeElementsByIdentifer() {
        ...
        Survey result = dao.getSurvey(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER_KEYS, true);
        assertSame(result, survey);
        assertEquals(result.getElements().size(), 1);
    ...
    public void getSurveyExcludeElementsByIdentifier() {
        ...
        Survey result = dao.getSurvey(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER_KEYS, false);
        assertSame(result, survey);
        assertEquals(result.getElements().size(), 0);
    ...
    public void getSurveyAllVersionsIncludeDeletedByIdentifier() {
        ...
        List<Survey> results = dao.getSurveyAllVersions(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER, true);
    ...
    public void getSurveyAllVersionsExcludeDeletedByIdentifier() {
        ...
        List<Survey> results = dao.getSurveyAllVersions(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER, false);
        assertEquals(results, ImmutableList.of(survey1A, survey1B));
    ...
    public void getSurveyMostRecentVersionByIdentifier() {
        ...
        Survey survey = dao.getSurveyMostRecentVersion(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER);
    ...
    public void getSurveyMostRecentlyPublishedVersionIncludeElementsByIdentifier() {
        ...
        Survey result = dao.getSurveyMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER, true);
    ...
    public void getSurveyMostRecentlyPublishedVersionExcludeElementsByIdentifier() {
        ...
        dao.getSurveyMostRecentlyPublishedVersion(TEST_STUDY_IDENTIFIER, SURVEY_IDENTIFIER, false);
    ...
    private void verifyStudyIdQueryCondition(DynamoDBQueryExpression<DynamoSurvey> query) {
        ...
        assertEquals(studyIdCond.getAttributeValueList().get(0).getS(), TEST_STUDY_IDENTIFIER);
    }
