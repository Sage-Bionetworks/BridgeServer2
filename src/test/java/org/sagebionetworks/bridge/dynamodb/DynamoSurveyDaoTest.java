...
public class DynamoSurveyDaoTest extends Mockito {
    ...
    static final String SURVEY_IDENTIFIER = "identifier:" + SURVEY_ID;
    ...
    public void updateSurvey() {
        ...
        Survey result = dao.updateSurvey(survey);
    ...
    public void versionSurvey() {
        ...
        Survey result = dao.versionSurvey(SURVEY_KEYS);
    ...
    public void deleteSurveyPermanently() {
        ...
        dao.deleteSurveyPermanently(SURVEY_KEYS);
        
        verify(mockSurveyMapper).delete(survey);
        verify(mockUploadSchemaService).deleteUploadSchemaByIdPermanently(TEST_STUDY, SURVEY_ID);
    }
    ...
    public void getSurveyIncludeElements() {
        ...
        Survey result = dao.getSurvey(SURVEY_KEYS, true);
        assertSame(result, survey);
    ...
    public void getSurveyExcludeElements() {
        ...
        Survey result = dao.getSurvey(SURVEY_KEYS, false);
        assertSame(result, survey);
    ...
    public void getSurveyNotFound() {
        ...
        assertNull(dao.getSurvey(SURVEY_KEYS, true));
    }
    ...
    public void getSurveyGuidForIdentifier() {
        ...
        String result = dao.getSurveyGuidForIdentifier(TEST_STUDY, SURVEY_ID);
    ...
    public void getSurveyAllVersionsExcludeDeleted() {
        ...
        List<Survey> results = dao.getSurveyAllVersions(TEST_STUDY, GUID, false);
        assertEquals(results, surveyList);
    ...
    public void getSurveyMostRecentlyPublishedVersionExcludeElements() {
        ...
        dao.getSurveyMostRecentlyPublishedVersion(TEST_STUDY, GUID, false);
    ...
    public void getAllSurveysMostRecentlyPublishedVersionExcludeDeleted() {
        ...
        dao.getAllSurveysMostRecentlyPublishedVersion(TEST_STUDY, false);
    ...
    public void getAllSurveysMostRecentVersionIncludeDeleted() {
        ...
        List<Survey> results = dao.getAllSurveysMostRecentVersion(TEST_STUDY, true);
        assertEquals(results.size(), 2);
        assertEquals(results.get(0).getCreatedOn(), TIMESTAMP);
        assertEquals(results.get(1).getCreatedOn(), TIMESTAMP);
        assertEquals(ImmutableSet.of(results.get(0).getGuid(), results.get(1).getGuid()),
    ...
    public void getAllSurveysMostRecentVersionExcludeDeleted() {
        ...
        dao.getAllSurveysMostRecentVersion(TEST_STUDY, false);
    ...
    public void secondaryIndexRequiresStudyId() {
        dao.versionSurvey(new DynamoSurvey());
    }
