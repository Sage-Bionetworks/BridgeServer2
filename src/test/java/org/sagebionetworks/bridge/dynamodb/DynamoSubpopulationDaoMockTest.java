...
public class DynamoSubpopulationDaoMockTest {
    ...
    public void createDefaultSubpopulationWritesCriteria() {
        Subpopulation subpop = dao.createDefaultSubpopulation(TEST_STUDY_IDENTIFIER);
    ...
    public void getSubpopulationRetrievesCriteria() {
        Subpopulation subpop = dao.getSubpopulation(TEST_STUDY_IDENTIFIER, SUBPOP_GUID);
    ...
    public void doNotAllowLogicalDeleteOfDefault() {
        ...
        doReturn(defaultSubpop).when(dao).getSubpopulation(TEST_STUDY_IDENTIFIER, SUBPOP_GUID);
    ...
    public void getSubpopulationsCreatesCriteria() {
        ...
        List<Subpopulation> list = dao.getSubpopulations(TEST_STUDY_IDENTIFIER, false, true);
    ...
    public void criteriaTableTakesPrecedenceOnGetList() {
        ...
        List<Subpopulation> subpops = dao.getSubpopulations(TEST_STUDY_IDENTIFIER, false, true);
