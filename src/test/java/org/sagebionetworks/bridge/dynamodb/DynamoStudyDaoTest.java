...
public class DynamoStudyDaoTest extends Mockito {
    ...
    public void doesIdentifierExistSucceeds() {
        ...
        boolean returned = dao.doesIdentifierExist(TEST_STUDY_IDENTIFIER);
        assertTrue(returned);
        
        verify(mockMapper).load(studyCaptor.capture());
        
        Study study = studyCaptor.getValue();
        assertEquals(study.getIdentifier(), TEST_STUDY_IDENTIFIER);
    }
    ...
    public void getStudy() {
        ...
        Study result = dao.getStudy(TEST_STUDY_IDENTIFIER);
        assertSame(result, saved);
        
        verify(mockMapper).load(studyCaptor.capture());
        Study key = studyCaptor.getValue();
        assertEquals(key.getIdentifier(), TEST_STUDY_IDENTIFIER);
    }
    
    @Test(expectedExceptions = EntityNotFoundException.class)
    public void getStudyNotFound() {
        dao.getStudy(TEST_STUDY_IDENTIFIER);   
    }
    ...
    public void deactivateStudy() {
        ...
        dao.deactivateStudy(TEST_STUDY_IDENTIFIER);
