...
public class HibernateAssessmentResourceTest {
    ...
    public void testFactoryMethod() {
        ...
        HibernateAssessmentResource resource = HibernateAssessmentResource.create(dto, API_APP_ID, "assessmentId");
        assertHibernateAssessmentResource(resource);
    }
    
    @Test
    public void testFactoryMethodWithNulls() {
        HibernateAssessmentResource resource = HibernateAssessmentResource.create(new AssessmentResource(), API_APP_ID, null);
