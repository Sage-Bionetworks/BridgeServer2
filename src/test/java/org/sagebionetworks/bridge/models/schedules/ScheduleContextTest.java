...
public class ScheduleContextTest {
    ...
    public void quietlyReturnsFalseForEvents() {
        ...
        ScheduleContext context = new ScheduleContext.Builder().withStudyIdentifier(TEST_APP_ID)
    ...
    public void verifyBuilder() {
        ...
        assertEquals(context.getCriteriaContext().getStudyIdentifier(), TEST_APP_ID);
    ...
    public void verifyNulls() {
        ...
        assertEquals(EMPTY_CONTEXT.getCriteriaContext().getStudyIdentifier(), TEST_APP_ID);
        assertEquals(EMPTY_CONTEXT.getCriteriaContext().getClientInfo(), ClientInfo.UNKNOWN_CLIENT);
    ...
    public void verifyAccountCreatedCopy() {
        ...
        ScheduleContext context = new ScheduleContext.Builder().withStudyIdentifier(TEST_APP_ID).build();
        ScheduleContext copy = new ScheduleContext.Builder().withContext(context).build();
        assertNull(copy.getAccountCreatedOn());
        
        // Non-null is properly copied
        DateTime now = DateTime.now(DateTimeZone.UTC);
        context = new ScheduleContext.Builder().withStudyIdentifier(TEST_APP_ID).withAccountCreatedOn(now).build();
