...
public class CriteriaUtilsTest {
    ...
    public void filterByCriteriaSortsByLanguageOrder() {
        ...
        context = new CriteriaContext.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER)
    ...
    private CriteriaContext.Builder getContext() {
        return new CriteriaContext.Builder().withStudyIdentifier(TEST_STUDY_IDENTIFIER);
    }
