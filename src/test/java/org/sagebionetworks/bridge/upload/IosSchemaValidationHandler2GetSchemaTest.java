...
public class IosSchemaValidationHandler2GetSchemaTest {
    ...
    public void survey() {
        ...
        when(mockSurveyService.getSurvey(eq(API_APP_ID),
        ...
        when(mockSchemaSvc.getUploadSchemaByIdAndRevNoThrow(API_APP_ID, "test-survey", 4)).thenReturn(
                dummySchema);
        ...
        UploadSchema retVal = handler.getUploadSchema(API_APP_ID, infoJson);
    ...
    public void itemWithDefaultRev() {
        ...
        UploadSchema dummySchema = UploadSchema.create();
        UploadSchemaService mockSchemaSvc = mock(UploadSchemaService.class);
        when(mockSchemaSvc.getUploadSchemaByIdAndRevNoThrow(API_APP_ID, "test-schema", 1)).thenReturn(
                dummySchema);
    ...
    public void itemWithLegacyMapRev() {
        ...
        UploadSchema dummySchema = UploadSchema.create();
        UploadSchemaService mockSchemaSvc = mock(UploadSchemaService.class);
        when(mockSchemaSvc.getUploadSchemaByIdAndRevNoThrow(API_APP_ID, "schema-rev-test", 2)).thenReturn(
                dummySchema);
    ...
    public void itemWithRev() {
        ...
        UploadSchema dummySchema = UploadSchema.create();
        UploadSchemaService mockSchemaSvc = mock(UploadSchemaService.class);
        when(mockSchemaSvc.getUploadSchemaByIdAndRevNoThrow(API_APP_ID, "schema-rev-test", 3))
    ...
    public void schemaless() {
        UploadSchema retVal = new IosSchemaValidationHandler2().getUploadSchema(API_APP_ID,
